...
var myController = require('../controllers/ctrlMedecin')
// afficher les pages
routeur.get('/liste_medecins',myController.afficher_liste_medecins)
routeur.get('/form_medecin', myController.afficher_form_medecin)
routeur.get('/fiche_medecin/:id', myController.afficher_fiche_medecin)
routeur.post('/form_medecin', myController.executer_form_medecin)
routeur.post('/fiche_medecin/:id', myController.update_form_medecin)
routeur.post('/delete_medecin/:id', myController.delete_fiche_medecin)
